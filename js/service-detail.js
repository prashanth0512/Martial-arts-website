const SERVICES = {
  karate: {
    ...
    gallery: [
      { src: '../images/karate_1.png', label: 'Kata Practice' },
      { src: '../images/karate_3.png', label: 'Black Belt Focus' },
      { src: '../images/karate_4.png', label: 'Flying Side Kick' },
      { src: '../images/karate_2.png', label: 'Group Training' },
      { src: '../images/hero.png', label: 'Traditional Dojo' },
      { src: '../images/about_hero_bg.png', label: 'Dojo Exterior' },
    ],
    testimonials: [
      {
        quote:
  ...
  'muay-thai': {
    ...
    gallery: [
      { src: '../images/muay_thai_1.png', label: 'Heavy Bag Work' },
      { src: '../images/muay_thai_3.png', label: 'Hand Wrapping' },
      { src: '../images/muay_thai_4.png', label: 'Fight Victory' },
      { src: '../images/muay_thai_2.png', label: 'Technical Clinch' },
      { src: '../images/programs.png', label: 'Bag Drills' },
      { src: '../images/join_class.png', label: 'Arena Training' },
    ],
    testimonials: [
      {
        quote:
...
function renderPricingCard(p) {
  return `
    <div class="pricing-card${p.featured ? ' featured-plan' : ''}">
      ${p.featured ? `<div class="popular-tag">MOST POPULAR</div>` : ''}
